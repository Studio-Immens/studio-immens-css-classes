...
(function () {
  ...
  if (typeof siCssDataFd === 'undefined') {
    console.warn('siCssDataFd non definito, impossibile inizializzare il CSS Class Editor');
    return;
  }
  ...
  (function injectDynamicCSS() {
    if (typeof document === 'undefined' || typeof siCssDataFd === 'undefined') {
      return;
    }
    ...
    styleEl.textContent = siCssDataFd.classes
      .map(c => `${c}`)
      .join('\n');
  })();
  ...
  function AddCSSClassControl(settings) {
    ...
    settings.edit = function (props) {
      ...
      // Filtra le classi
      const filtered = siCssDataFd.classes.filter((cls) => 
        ...
        props.isSelected &&
          createElement(
            ...
            createElement(
              PanelBody,
              {
                title: siCssDataFd.labels.title || 'Foundation Classes',
                initialOpen: false,
                className: 'studioimmens-css-control',
              },
              // Campo di ricerca
              createElement(TextControl, {
                label: siCssDataFd.labels.search || 'Search Classes',
                value: searchTerm,
                onChange: setSearchTerm,
                placeholder: siCssDataFd.labels.ttos || 'Type to search...',
              }),
                ...
                ? createElement(
                    ...
                    filtered.length > 0
                      ...
                      : createElement(
                          'p',
                          {},
                          siCssDataFd.labels.nofound || 'No classes found'
                        )
                  )
                : null
            )
  ...
  addFilter(
    ...
    'studioimmens/css-classes-foundation',
    AddCSSClassControl
  );
})();
